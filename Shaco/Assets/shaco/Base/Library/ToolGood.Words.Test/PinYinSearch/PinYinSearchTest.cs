...
namespace shaco.Base.ToolGoodWords.Test
{
    ...
    public class PinYinSearchTest
    {
        ...
        public void Test()
        {
            ...
            shaco.Base.Utility.AssetAreEqual(3, t.Count);
            shaco.Base.Utility.AssetAreEqual("安道尔", t[0]);
            shaco.Base.Utility.AssetAreEqual("澳大利亚", t[1]);
            shaco.Base.Utility.AssetAreEqual("澳地利", t[2]);

            t = search.SearchTexts("ad",false);
            shaco.Base.Utility.AssetAreEqual(3, t.Count);
            shaco.Base.Utility.AssetAreEqual("澳大利亚", t[0]);
            shaco.Base.Utility.AssetAreEqual("澳地利", t[1]);
            shaco.Base.Utility.AssetAreEqual("安道尔", t[2]);


            var t2 = search.SearchTexts("bl");
            shaco.Base.Utility.AssetAreEqual(8, t2.Count);


            var t3 = search.SearchTexts("白e");
            shaco.Base.Utility.AssetAreEqual("白俄罗斯", t3[0]);
            shaco.Base.Utility.AssetAreEqual(1, t3.Count);

            var t4 = search.SearchTexts("baie");
            shaco.Base.Utility.AssetAreEqual("白俄罗斯", t4[0]);
            shaco.Base.Utility.AssetAreEqual(1, t4.Count);

            var t5 = search.SearchTexts("bai俄");
            shaco.Base.Utility.AssetAreEqual("白俄罗斯", t5[0]);
            shaco.Base.Utility.AssetAreEqual(1, t5.Count);
        ...
        public void Test2()
        {
            ...
            shaco.Base.Utility.AssetAreEqual("澳大利亚", t[0]);
            shaco.Base.Utility.AssetAreEqual(1, t.Count);
            ...
            shaco.Base.Utility.AssetAreEqual(1, t2.Count);
