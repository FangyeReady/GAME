...
using shaco.ICSharpCode.SharpZipLib.Encryption;
#endif

using shaco.ICSharpCode.SharpZipLib.Core;
using shaco.ICSharpCode.SharpZipLib.Checksums;
using shaco.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using shaco.ICSharpCode.SharpZipLib.Zip.Compression;

namespace shaco.ICSharpCode.SharpZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="shaco.ICSharpCode.SharpZipLib.Zip.ZipException">
 ...
 */
		...
		void ReadEntries()
		{
			...
			if ( (thisDiskNumber == 0xffff) ||
                ...
                ReadLEUlong();// ulong recordSize = ReadLEUlong();
                ReadLEUshort();// int versionMadeBy = ReadLEUshort();
                ReadLEUshort();// int versionToExtract = ReadLEUshort();
                ReadLEUint();// uint thisDisk = ReadLEUint();
                ReadLEUint();// uint centralDirDisk = ReadLEUint();
			...
			for (ulong i = 0; i < entriesForThisDisk; i++) {
                ...
                ReadLEUshort();// int diskStartNo        = ReadLEUshort();  // Not currently used
                ReadLEUshort();// int internalAttributes = ReadLEUshort();  // Not currently used
