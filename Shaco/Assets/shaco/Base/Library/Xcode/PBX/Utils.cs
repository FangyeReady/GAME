...
namespace shaco.iOS.Xcode
{
    ...
    internal class FileTypeUtils
    {
            ...
            new Dictionary<string, FileTypeDesc>
        {
            ...
            { "jpg",         new FileTypeDesc("image.jpg",               PBXFileType.Resource) },
            ...
            { "html",        new FileTypeDesc("text.html",               PBXFileType.Resource) },
            { "xcdatamodeld",new FileTypeDesc("coredata.xcdatamodeld",   PBXFileType.Resource) },
