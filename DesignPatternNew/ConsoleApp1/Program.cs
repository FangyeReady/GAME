...
namespace DesignPattern
{
    ...
    {
        public override void DoOperation(int num1, int num2)
        {
            Console.WriteLine("num1 + num2 = " + (num1 + num2));
        }
    }

    public class DelOperation : Strategy
    {
        public override void DoOperation(int num1, int num2)
        {
            Console.WriteLine("num1 - num2 = " + (num1 - num2));
    ...
    public class MulityOperation : Strategy
    {
        public override void DoOperation(int num1, int num2)
        {
            Console.WriteLine("num1 * num2 = " + (num1 * num2));
    ...
    public class ChuOperation : Strategy
    {
        public override void DoOperation(int num1, int num2)
        {
            Console.WriteLine("num1 / num2 = " + (num1 / num2));
    ...
    {
        private Strategy hanlder;
        public Context(Strategy strategy)
        {
            this.hanlder = strategy;
        }

        public void ExcuteOperation(int num1, int num2)
        {
            this.hanlder.DoOperation(num1, num2);
        }
    ...
    public class WOW : RPGGame
    {
        protected override void EndGame()
        {
            Console.WriteLine("GAME OVER NOT GET WU DI");
        }

        protected override void InitGame()
        {
            Console.WriteLine("INIT A ER SA SI");
        }

        protected override void StartGame()
        {
            Console.WriteLine("START GO TO FU BEN");
        }
    ...
    class Program
    {
        static void Main()
        {
            ...
            #region 策略模式
            //-------------------------------------------------------策略模式：当一个系统中有多个算法时，可以让它们封装成对象----------------------------------------------
            //策略模式将所有的算法分别封装成对象，并且对象之间可以相互随时替换,扩展性好
            //Context contextWorker1 = new Context(new AddOperation());
            //Context contextWorker2 = new Context(new DelOperation());
            //Context contextWorker3 = new Context(new MulityOperation());
            //Context contextWorker4 = new Context(new ChuOperation());

            //contextWorker1.ExcuteOperation(100, 5);
            //contextWorker2.ExcuteOperation(100, 5);
            //contextWorker3.ExcuteOperation(100, 5);
            //contextWorker4.ExcuteOperation(100, 5);
            #endregion
