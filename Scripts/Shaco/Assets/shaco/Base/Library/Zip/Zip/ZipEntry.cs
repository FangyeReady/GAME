...
namespace shaco.ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipEntry : ICloneable
	{
		...
		/// </returns>
		/// <see cref="shaco.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Deflated"/>
		/// <see cref="shaco.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Stored"/>
...
//				return (byte[]) extra.Clone();
				...
				while ( extraData.UnreadCount >= 4 ) {
					...
					if ( ntfsTag == 1 ) {
						if ( ntfsLength >= 24 ) {
                            ...
                            extraData.ReadLong(); // long lastAccess = extraData.ReadLong();
                            extraData.ReadLong(); //long createTime = extraData.ReadLong();
		...
		private void ProcessAESExtraData(ZipExtraData extraData) {
			...
			if (extraData.Find(0x9901)) {
                ...
                extraData.ReadShort();// int vendorId = extraData.ReadShort();		// 2-character vendor ID 0x4541 = "AE"
