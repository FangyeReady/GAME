...
namespace CSObjectWrapEditor
{
...
#else
        public static string common_path = shaco.Base.FileHelper.GetCurrentSourceFolderPath().RemoveLastPathByLevel(2) + "/Gen/";
#endif
    ...
    public static class Generator
    {
        ...
        static bool clear(string path)
        {
            ...
            {
                Debug.LogWarning("Xlua Generator clear waning: missing path=" + path);
            }
...
#pragma warning restore 618
        ...
        [MenuItem("shaco/XLua/Generate Code", false, 1)]
        public static void GenAll()
        {
            if (EditorApplication.isCompiling || Application.isPlaying)
            {
                UnityEngine.Debug.LogError("You can't generate before the compilation is done");
                return;
            }
            ...
            shaco.DataSave.Instance.Write("Generator.XluaDelayHotfixInject", true);
        }

        [MenuItem("shaco/XLua/Clear Generated Code", false, 2)]
        ...
        public static void CheckGenrate()
        {
            ...
            {
                throw new InvalidOperationException("Xlua error: Code has not been genrated, may be not work in phone!");
            }
        }
#endif
    }
